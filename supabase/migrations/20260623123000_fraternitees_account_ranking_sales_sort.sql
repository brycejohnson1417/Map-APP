...
with base as (
  select
    ...
    nullif(trim(coalesce(account.sales_rep_names[1], account.custom_fields ->> 'primarySalesRepName')), '') as primary_sales_rep,
...
select
  ...
  base.city,
  base.state,
  base.sales_rep_names,
  base.primary_sales_rep,
