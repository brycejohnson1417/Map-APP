...
The current workspace seed enables Screenprinting Sales, Social, social publishing, comments/replies, and messages for FraterniTees while leaving catalog costs and profitability disabled. Live Meta actions remain permission-gated until the platform Meta app is configured, FraterniTees authorizes owned accounts, grants the required scopes, and maps owned Instagram account IDs.
