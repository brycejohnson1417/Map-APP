            ...
            >
              <div className="flex flex-wrap items-center gap-3 px-4 py-4 md:px-5">
                ...
                <button
                  ...
                  aria-controls={`expanded-request-${request.id}`}
                >
              ...
              {expanded ? (
                <div id={`expanded-request-${request.id}`} className="border-t border-[var(--border-subtle)] bg-[var(--surface-card)] px-4 py-4 md:px-5">
                  {previewImage?.signedUrl ? (
                    <a
                      href={previewImage.signedUrl}
                      target="_blank"
