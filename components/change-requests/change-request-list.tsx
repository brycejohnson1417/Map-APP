            ...
            >
              <div className="flex flex-wrap items-center gap-3 px-4 py-4 md:px-5">
                ...
                <button
                  ...
                  aria-controls={`request-content-${request.id}`}
              ...
              {expanded ? (
                <div id={`request-content-${request.id}`} className="border-t border-[var(--border-subtle)] bg-[var(--surface-card)] px-4 py-4 md:px-5">
                  {previewImage?.signedUrl ? (
                    <a
                      href={previewImage.signedUrl}
                      target="_blank"
