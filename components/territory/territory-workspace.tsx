...
export function TerritoryWorkspace({ orgSlug, initialDashboard, territoryConfig }: TerritoryWorkspaceProps) {
  ...
  // ⚡ Bolt Optimization: Construct O(1) Map dictionary to prevent O(N*M) nested array lookups during React renders
  ...
  const routeStops = useMemo(
    () =>
      routePlanningEnabled
        // ⚡ Bolt Optimization: Use Map lookup instead of Array.find inside .map
