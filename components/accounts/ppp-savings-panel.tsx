      ...
      {report && collapsed ? (
        ...
        <div className="grid gap-0 xl:grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="flex min-w-0 flex-col">
            ...
            <div className="flex min-h-[24rem] w-full flex-col overflow-hidden bg-white text-sm text-black">
              <iframe
                title="Email Preview"
                srcDoc={sanitizedEmailHtml}
                sandbox="allow-popups allow-popups-to-escape-sandbox"
                className="h-full min-h-[24rem] w-full flex-1 border-none bg-white p-6"
              />
            </div>
          </div>
        </div>
