...
export function PppSavingsPanel({ orgSlug, accountId }: PppSavingsPanelProps) {
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] border border-[var(--border-subtle)] bg-[var(--surface-card)] shadow-[var(--shadow-soft)]">
        ...
        <div className="flex flex-wrap gap-2">
          {report ? (
            <button
              ...
              aria-controls={`ppp-savings-content-${accountId}`}
      ...
      {report && collapsed ? (
        <div id={`ppp-savings-content-${accountId}`} className="flex flex-wrap items-center justify-between gap-3 p-5 text-sm">
        ...
        <div id={`ppp-savings-content-${accountId}`} className="grid gap-0 xl:grid-cols-[0.75fr_1.25fr]">
