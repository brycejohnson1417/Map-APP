        ...
        <div className="grid gap-0 xl:grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="flex min-w-0 flex-col">
            ...
            <div className="min-h-[24rem] w-full bg-white text-sm text-black">
              <iframe
                title="Email Preview"
                srcDoc={`<style>body { font-family: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 14px; margin: 0; padding: 1.5rem; color: #000; }</style>${sanitizedEmailHtml}`}
